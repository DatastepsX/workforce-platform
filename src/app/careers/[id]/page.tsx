      ...
      <div className="mb-6">
        <div className="flex flex-wrap gap-2 mb-3">
          ...
          {demand.remote_allowed && (
            <span className="text-[12px] font-semibold px-2.5 py-1 rounded-full bg-[#007AFF]/10 text-[#007AFF]">
              Remote OK
            </span>
          )}
        </div>
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-1 mt-2 text-[14px] text-[#8E8E93]">
          ...
          {demand.start_date && (
            <span>Start {new Date(demand.start_date).toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}</span>
          )}
